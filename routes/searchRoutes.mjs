...
router.get('/searchByShopName/:serviceType/:query/:lng/:lat/:radiusKm/:page', verifyAccessToken, controllerWrapper(searchController.searchVendorsByShopName, { logRequest: true, logResponse: true })); //GET: /search/query/city eg: /search/vendor1/kochi/100
